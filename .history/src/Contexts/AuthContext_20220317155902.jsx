...
export default function AuthContextProvider({ children }) {
  const [currentUser, setCurrentUser] = useState({uid:1234, email:"email",displayName:"name",photoURL:"https://cdn.freebiesupply.com/logos/large/2x/ck-logo-svg-vector.svg"})
