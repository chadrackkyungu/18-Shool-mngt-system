...
// React Context user useAuth Func
import { useAuth } from "../../Contexts/AuthContext"

const Register = props => {
  const handleValidSubmit = (event, values) => {
    // props.registerUser(values) //this is redux action from the existing project

    register(event, values).then(res => {
      console.log(res)
    })
  }

  //here am importing the user action from react ContextApi
          ...
          <Row className="justify-content-center">
            <Col md={8} lg={6} xl={4}>
              ...
              <div className="mt-5 text-center">
                ...
                <p>
                  Copyright School Management System ©{new Date().getFullYear()}
                </p>
              </div>
            </Col>
          </Row>
