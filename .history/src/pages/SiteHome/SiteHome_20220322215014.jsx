            ...
            <Col className="col-4 sm-col-12 mt-5">
              ...
              <Card >
                <CardBody>
                  ...
                  <p className="card-title-desc">
                  Welcome to Richfield's Moodle Learner Management System Platform. If this is your first login, kindly use your ITS 9 Digit Student Number as your username and your ID / Passport Number or R!chfield+2022 as your password. You must update your contact details on first login so that you can receive all relevant notices and information.
                  </p>


                  <p className="card-title-desc">
                      Should you require any support, kindly send your Moodle related queries to the below email address:
                      Email address: <b> moodle@richfield.ac.za </b> 
                      We will respond to your query within 6 to 48 working hours.
                  </p>



                  <a href="#"> Please click here to download Moodle User Guide
</a>
                </CardBody>
              </Card>
