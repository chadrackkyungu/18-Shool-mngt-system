...
import { FcOpenedFolder, FcQuestions, FaFilePdf } from 'react-icons/fc';
            ...
            <Card >
              ...
              <Col className="xl-col-6 sm-col-12 mt-5 flex-md-column">
                ...
                <ul>
                  ...
                  <li> <a href="#"> <BsFillChatLeftTextFill size={25} /> Real-time Chat room </a></li>
                  <li> <a href="#"> <BsFillChatLeftTextFill size={25} /> Glossary of terms </a></li>
                  <h3> Material </h3>
