            ...
            <Card >
              ...
              <Col className="xl-col-6 sm-col-12 mt-5 flex-md-column">
                ...
                <ul>
                  ...
                  <li> <a href="#"> <BsFillChatLeftTextFill size={30} /> Glossary of terms </a></li>
                  <h3> Material </h3>
                  <li> <a href="#"> <GiUsbKey size={30} /> Key definitions used in this moduleGlossary </a></li>
                  <li> <a href="#"> <AiFillFileText size={30} /> Contextual application of SAQA level descriptorsPage </a></li>
                  <li> <a href="#"> <AiFillFileText size={30} /> Assessment and examinations for this modulePage </a></li>
                  <li><a href="#"> <FcOpenedFolder size={30} />Past Year PapersFolder </a></li>
