        ...
        <Container fluid>
          <div className="page-title-box">
            <Row className="align-items-center">
              <Col md={8}>
                <h6 className="page-title">SCHOOL MANAGEMENT SYSTEM</h6>
                ...
                <div class="card overflow-hidden radius-10">
                  ...
                  <div class="card-body">
                    <div class="mt-5 d-flex align-items-start justify-content-between">
                      ...
                      <div class="">
                         <a href="javascript:;" class="btn btn-dark"><ion-icon name="send-sharp"></ion-icon>Send Message</a>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <Card className="mini-stat bg-warning text-white">
                <CardBody>
                  <div className="mb-4" data-aos={"fade-left"}>
                    ...
                    <h4 className="fw-medium font-size-24">
                      15.8
                      <i className="mdi mdi-arrow-up text-white ms-2"></i>
                    </h4>
