...
import AccessAdmin from '../pages/Access-Admin/AccessAdmin';
import CourseDetail from '../pages/Course-Detail-Page/CourseDetail';
import User_auth_detailts from '../pages/User-Auth-Table-Details/user_auth_detailts';
import News_or_Notification from '../pages/News-Notification/News_Notification';
...
const userRoutes = [
  ...
  { path: "/access-admin", component: AccessAdmin },
  { path: "/course-detail/:courseId", component: CourseDetail },
  { path: "/user-auth-table-details", component: User_auth_detailts },
  { path: "/notifications", component: News_or_Notification },
