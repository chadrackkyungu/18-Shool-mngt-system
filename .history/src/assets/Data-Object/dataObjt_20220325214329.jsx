const coursesObj = [
    {
      ...
      chapters:{
        ...
        p:"Describe business analysis and the role of the business analyst.",
        p:"Explain the Business Analysis Core Concept Model (BACCM™).",
        p:"Explore the six business analysis knowledge areas.",
        p:"Recognize the basic contents, structure, and intent of the BABOK ® Guide.", p:"Define the BABOK ® Guide requirements classification scheme.", 
        p:"Map business analysis activities to a generic project life cycle.",
        p:"Understand the content and intent of the BABOK ® Guide. "
      }
    ...
    },
    {
      ...
      chapters:{
        one:"Learning Objectives",
        p:"Plan business analysis approach.",
        p:"Plan stakeholder engagement.",
        p:"Plan business analysis governance.",
        p:"Plan business analysis information management process.", 
        p:"Identify business analysis performance improvements.", 
    ...
    },
    {
      ...
      chapters:{
        one:"Learning Objectives",
        p:"Understand the current state of the business.",
        p:"Define the desired future state of the business.",
        p:"Assess the risks inherent to the change.",
        p:"Develop a change strategy to achieve the desired business outcome.", 
